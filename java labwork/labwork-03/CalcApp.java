...
class View {  //added the class View 
  public static void showMenu() { //here, the showMenu method has static keyword which means it is part of the main method and println will work
